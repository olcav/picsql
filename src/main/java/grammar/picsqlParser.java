...
public class picsqlParser extends Parser {
	...
	public static final int
		...
		DISCR=27, BUTTER=28, MODULO=29, PLUS=30, MINUS=31, DIGITS=32, DECIMAL=33, 
		STR=34, SPECIAL_CHAR=35, STR_PATH=36, DOTS=37, LEFT_PARENTHESIS=38, RIGHT_PARENTHESIS=39, 
		LEFT_BRACKET=40, RIGHT_BRACKET=41, OPERATOR_CONDITION=42, DOT=43, IN=44, 
		WS=45;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'discr'", "'butter'", "'%'", "'+'", "'-'", null, null, null, null, null, 
			"':'", "'('", "')'", "'['", "']'", null, "'.'", "'in'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RANK", "PI", "SIN", "COS", "TAN", "LAG", "LEAD", "FLIP", "DISCR", "BUTTER", 
			"MODULO", "PLUS", "MINUS", "DIGITS", "DECIMAL", "STR", "SPECIAL_CHAR", 
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(109);
						_la = _input.LA(1);
						if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 536871104L) != 0) ) {
