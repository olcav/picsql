public class QueryBank {
    ...
    public static final String[] QUERIES = {
            ...
            "select r*2,g+2,b-5 from ./examples/face.bmp",
            "select t.r,t.g,t.b from ./examples/face.bmp t",
            "select t.r,t2.r,t.g from ./examples/face.bmp t, ./examples/face.bmp t2",

            // Where
            "select * from ./examples/face.bmp where r = 2",
            "select * from ./examples/face.bmp where r = 2 and g > 10",
            "select * from ./examples/face.bmp where r < b",
